...
function addcart(str) {
  ...
  xhttp.open("GET", "updatetry.php?id="+str, true);
  xhttp.send();
}
</script>
<table>
...
<td style="border: 1px solid black"><font color=red>Update</font></td>	
...
<td style="border: 1px solid black"><button type="submit" class="btn btn-success btn-xs" onclick="addcart(<?php echo $row['pro_id']; ?>)">Update</button></td>

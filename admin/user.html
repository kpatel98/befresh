            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li class="active-link">
                        <a href="" ><i class="fa fa-line-chart"></i>Progress <span class="badge"></span></a>
                    </li>
                   
					 <li>
                        <a href=""><i class="fas fa-box-open"></i>Order  <span class="badge"></span></a>
                    </li>
				   
                    <li>
                        <a href="index.html"><i class="fa fa-cart-plus "></i>Product  <span class="badge"></span></a>
                    </li>
                    <li>

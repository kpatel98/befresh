         ...
         <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="adjust-nav">
                ...
                <span class="logout-spn" >
                  <a href="alogin.php" style="color:#fff;">LOGOUT</a>  
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li >
                        <a href="home.php" ><i class="fa fa-line-chart"></i>Progress <span class="badge"></span></a>
                    </li>
                   
					 <li>
                        <a href="order.php"><i class="fas fa-box-open"></i>Order  <span class="badge"></span></a>
                    </li>
				   
                    <li>
                        <a href="product.php"><i class="fa fa-cart-plus "></i>Product  <span class="badge"></span></a>
                    </li>
                    <li>
                        <a href="customer.php"><i class="fa fa-group "></i>Customer  <span class="badge"></span></a>
                    </li>
